					...
					<div className="code-content">
						<code>
							<p className="line-1">
								...
								<span className="c-2">{"fullName "}</span>{"= "}
								<span className="c-3">
									“<i>Mukhlis Adhe Purwanto</i>”</span>;
							</p><br/>
							<p className="line-2">
								<span className="c-1">{"let "}</span>
								<span className="c-2">{"Age "}</span>{"= "}
								<span className="c-4">
									<i>{1900 + new Date( ).getYear( ) - 1998}</i>
								</span>;
							</p><br/><br/>
							<p className="line-3">
								<span className="c-1">{"export default "}</span>
								<span className="c-2">{"Description "}</span>
								<span className="c-1">{"extends "}</span>
								<span className="c-3">{"Component "}</span>{"{"}</p><br/>
							<p className="line-4">
								<span className="c-5">{"render"}</span>{"() {"}</p><br/>
							<p className="line-5">
								<span className="c-1">{"return"}</span>{"("}</p>
							<br/>
							<p className="line-6">{"<"}
								<span className="c-6">{"span"}</span>{">"}</p>
							<br/>
							<p className="desc-1">Hi, I am a student from Informatics Bachelor Degree</p>
							<br/>
							<p className="desc-2">of The Institute of Technology Telkom Purwokerto.</p>
							<br/>
							<p className="desc-3">I am very interested as a Software Engineer who</p>
							<br/>
							<p className="desc-4">has motivation and passion for creative and</p>
							<br/>
							<p className="desc-5">innovative technology. I really like creating</p>
							<br/>
							<p className="desc-6">beautiful and powerful software that puts</p>
							<br/>
							<p className="desc-7">performance and aesthetic look, and</p><br/>
							<p className="desc-8">I’d love to talk to you, so</p><br/>
							<p className="line-8">{"</"}
								<span className="c-6">{"span"}</span>{">"}</p>
							<br/>
							<p className="line-9">{")"}</p><br/>
							<p className="line-10">{"}"}</p><br/>
							<p className="line-11">{"}"}</p><br/>
						</code>
					</div>
				</div>
			</div>
